...
public class CameraRotator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            newAngle.x = mainCamera.transform.localEulerAngles.x;
            newAngle.y = player.transform.localEulerAngles.y;
        ...
        else if (Input.GetMouseButton(0))
        {
            ...
            if (!reverse)
            {
                ...
                mainCamera.transform.localEulerAngles = new Vector3(newAngle.x, 0, 0);

                // マウス座標を変数"lastMousePosition"に格納
                lastMousePosition = Input.mousePosition;
                player.transform.localEulerAngles = new Vector3(0, newAngle.y, 0);
            }
